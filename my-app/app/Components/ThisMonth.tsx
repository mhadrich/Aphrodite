...
export default function ThisMonth() {
  return (
    ...
    <div className="flex-col ml-[-825px] justify-start  items-start gap-3 ">
      ...
      <Link href="/AllProducts">
        <div className="w-40 h-14 absolute mt-[-25px] right-[196px] px-12 py-4 bg-red-500 rounded items-center gap-3 ">

      ...
      <div className="w-screen px-52 h-96 justify-start items-start gap-5 inline-flex">
        ...
        <div className="w-96 h-96 flex-col justify-start items-start gap-2 inline-flexq">
          ...
          <div className="flex-col justify-start items-start gap-2 flex">
            <p className="text-black dark:text-white text-3xl font-medium leading-loose tracking-wider">
              Ahlem Selmi
            </p>
            ...
            <div className="justify-start items-start gap-3 inline-flex">
              <Link className="dark:invert" href="https://www.facebook.com" target="_blank">
                <img
                  className="w-6 h-6 relative"
                  src="https://cdn4.iconfinder.com/data/icons/social-media-and-logos-12/32/Logo_facebook-1024.png"
                />
              </Link>
              <Link className="dark:invert" href="https://www.instagram.com" target="_blank">
                <img
                  className="w-6 h-6 relative"
                  src="https://cdn4.iconfinder.com/data/icons/social-media-and-logos-12/32/Logo_Instagram-1024.png"
                />
              </Link>
              <Link className="dark:invert" href="https://www.linkedin.com" target="_blank">
                <img
                  className="w-6 h-6 relative"

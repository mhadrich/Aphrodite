...
export default function ProductDetail() {
  const [big,setBig] = useState('https://c-co.niceshops.com/upload/image/product/large/default/29272_f54416ea.1024x1024.png');
  return (
    <main className="flex min-h-screen flex-col items-center justify-between pl-5 pr-5">
      ...
      <div className="inline-flex gap-5">
        ...
        <div className="w-28 h-96 flex flex-col gap-5">
          <div>
            <img
              onClick={()=>setBig('https://c-co.niceshops.com/upload/image/product/large/default/29272_f54416ea.1024x1024.png')}
          ...
          <div>
            <img
              onClick={()=>setBig('https://c-co.niceshops.com/upload/image/product/large/default/xerjoff-erba-pura-eau-de-parfum-392922-fr.png')}
              className="w-28 h-28  rounded justify-center items-center border opacity-80 hover:opacity-100"
          ...
          <div>
            <img
              onClick={()=>setBig('https://c-co.niceshops.com/upload/image/product/large/default/xerjoff-erba-pura-eau-de-parfum-392936-fr.jpg')}
              className="w-28 h-28  rounded justify-center items-center border opacity-80 hover:opacity-100"
          ...
          <div>
            <img
              onClick={()=>setBig('https://c-co.niceshops.com/upload/image/product/large/default/xerjoff-erba-pura-eau-de-parfum-392943-fr.jpg')}
        ...
        <div className="w-96 h-96 flex-col justify-center items-center">
          ...
          <div className="mb-6">
            <div className="w-40 h-11 justify-start items-start inline-flex">
              <div className="group">
                <button className="w-10 h-11 px-2 py-2.5 rounded-tl rounded-bl border border-black border-opacity-50 flex-col justify-center items-center inline-flex group-hover:bg-red-500 group-hover:border-opacity-0">
              ...
              <div className="group">
                <button className="w-10 h-11 px-2 py-2.5 border border-black border-opacity-50 rounded-tr rounded-br flex-col justify-center items-center inline-flex group-hover:bg-red-500 group-hover:border-opacity-0">
                  <p className="text-black group-hover:text-neutral-50">+</p>
                </button>
              </div>
            </div>
            ...
            <button className="w-40 h-11 bg-red-500 rounded justify-center items-center inline-flex hover:bg-red-300">

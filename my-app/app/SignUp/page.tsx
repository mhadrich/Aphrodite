      ...
      <div className="flex gap-6 mx-auto my-10 max-w-screen-lg">
        ...
        <div className="flex flex-col w-1/2 gap-6 p-10 bg-white rounded shadow-lg">
          ...
          <div className="flex flex-col items-start gap-6">
            <button className="w-full px-32 py-4 bg-red-500 rounded text-neutral-50 text-base font-medium">Create Account</button>
            <div className="flex flex-col gap-6 items-start">
              ...
              <div className="flex flex-col items-start gap-1">
                ...
                <button className="opacity-70 text-black text-base font-medium underline">Log in</button>
              </div>
            </div>
          </div>
        </div>
